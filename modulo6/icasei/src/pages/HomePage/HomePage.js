...
import './style.css'
import VideoGridPage from '../../components/VideoGridPage/VideoGridPage'
        ...
        return (
            ...
            <>
                <div id="searchBox" className="searchBoxCenter">
                    <SearchPage searchAction={(searchText) => this.searchAction(searchText)} />
                </div>
                ...
                {this.state.videosGridEnable && <div className="videoGrid">
                    <InfiniteScroll
                        ...
                        threshold={500}
                    >
                        <VideoGridPage videos={this.state.videos} searchText={this.state.searchText} />
                    </InfiniteScroll>
                </div>}

                {
                    this.state.errorDisplay && <ErrorPage />
                }
            </>
        );
    }
